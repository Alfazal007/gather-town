...
export default function ChatDisplay({ messages, onLeaveRoom, onSendMessage }: ChatDisplayProps) {
    ...
    return (
        <div className="w-1/5 h-3/4 fixed top-2 right-4 mr-2 top-1/4 flex flex-col bg-gray-50 dark:bg-gray-800 border-l border-t border-gray-200 dark:border-gray-700 rounded-tl-lg shadow-lg">
